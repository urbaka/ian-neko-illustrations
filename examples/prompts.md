...
```text
Use $ian-xiaohei-illustrations 这张图方向对，但neko有点像装饰。
请保持核心意思不变，重生成一版：让neko成为真正推动结构运转的人。
画面更怪一点，但仍然纯白、清爽、少字。
```
...
```text
Use $ian-xiaohei-illustrations 输出 5 个不同主题的neko正文配图效果。
